...
const firebaseConfig = {
  ...
  document.addEventListener('DOMContentLoaded', () => {
      ...
      if (document.getElementById('prevProjectBtn') && document.getElementById('nextProjectBtn')) {
      ...
      if (document.getElementById('prevAlbumBtn') && document.getElementById('nextAlbumBtn')) {
